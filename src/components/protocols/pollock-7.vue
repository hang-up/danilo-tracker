  ...
  <form>
    <div class="form-container">
      <div class="g grid-100 grid-m-100">
        <h3>Protocol: Pollock 7 sites</h3>
      </div>
      ...
      <div class="g grid-33 grid-m-25"></div>
      <div class="g grid-25 grid-m-50">
        <label class="label" for="size4">Size 4</label>
        <input class="input number" type="number" name="size4" v-model="measures.size4" />
      </div>
      <div class="g grid-33 grid-m-25"></div>

      <div class="g grid-33 grid-m-25"></div>
      <div class="g grid-25 grid-m-50">
        <label class="label" for="size5">Size 5</label>
        <input class="input number" type="number" name="size5" v-model="measures.size5" />
      </div>
      <div class="g grid-33 grid-m-25"></div>

      <div class="g grid-33 grid-m-25"></div>
      <div class="g grid-25 grid-m-50">
        <label class="label" for="size6">Size 6</label>
        <input class="input number" type="number" name="size6" v-model="measures.size6" />
      </div>
      <div class="g grid-33 grid-m-25"></div>

      <div class="g grid-33 grid-m-25"></div>
      <div class="g grid-25 grid-m-50">
        <label class="label" for="size7">Size 7</label>
        <input class="input number" type="number" name="size7" v-model="measures.size7" />
      </div>
      <div class="g grid-33 grid-m-25"></div>
